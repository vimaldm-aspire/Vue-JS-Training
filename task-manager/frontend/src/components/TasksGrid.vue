<template>
  <div class="p-6 relative">
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
      <input v-model="filters.title" placeholder="Filter by title" class="border p-2 rounded" />
      <input v-model="filters.description" placeholder="Filter by description" class="border p-2 rounded" />
